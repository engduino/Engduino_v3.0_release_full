...
* E.g.: inVals = [69,110,103,100,117,105,110,111] -> "Engduino"
*/
...
{
	outVals[0] = (long)(engduinoThermistor->temperature()*1000.0); // Convert to mili °C
}
...
{
	outVals[0] = (long)(engduinoLight->lightLevel()); // A 10 bit value - so in a range 0-1023
	PRINT("SENSOR_LIGHT: ");
	PRINTLN(outVals[0]);
}
